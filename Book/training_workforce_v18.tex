...
%%%%%%%%%%%%%%%%%%%%%% First Page
\title{\capitalizedtext{ Generative AI and Workforce Development in the Finance Sector}\\\small{Policy Projections, Risk Mitigation, and Future Challenges in the U.S}}
\author{
...
\minisec{Yes, ChatGPT helped me a little (not a lot) to write this Book!}
...
\dictum% 
[Satya Nadella]%author 
{AI is perhaps one of the most transformative things of our time. It is more profound than electricity or fire.}
...
\begin{itemize}
	\item \textbf{Finance:} AI-powered risk assessment and fraud detection require specialized training programs \cite.
...
\minisec{Future of Prompt Engineering in Workforce Training}
